...
class OpenAIQueryBuilder {
  ...
  private suggestRecipiesSystemMessage = 'Ton but est de donner 5 suggestion de plat similaire a celui que je vais te dire. Ils ne doivent pas tous reprendre l\'ingredient pricipal du plat. Répond impérativement en français. Formatte le plat et réponds uniquement au format JSON. Ce JSON devrai uniquement contenir les champs title (string), description (string)';
